...
There was an [[https://github.com/john2x/jenkinsfile-mode/pull/11][unmatched paren]].

#+begin_src diff :tangle jenkinsfile-mode-pr-11.diff
diff --git a/jenkinsfile-mode.el b/jenkinsfile-mode.el
index b666427..71386b9 100644
