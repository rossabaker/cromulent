...
:EXPORT_HUGO_LASTMOD: <2022-10-16 Sun 22:11>
:END:
...
:EXPORT_HUGO_LASTMOD: <2022-10-16 Sun 23:08>
:END:
...
#+begin_src css :tangle ../../tmp/hugo/assets/css/cromulent.css
  :root {
      ...
      --dark-color: #191919;
      --link-color: #01426a;
      --link-visited-color: #512a44;
      --link-hover-color: #006298;
  }
  ...
  @media (min-width: 576px) {
      body > * {
          background: linear-gradient(
              ...
              var(--brand-color) 12px,
              var(--brand-color) 14px,
              var(--light-color) 14px
          );
      }
  }
#+end_src
...
Links are in the traditional blue and purple.
