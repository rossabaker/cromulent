...
#+begin_aside
#+attr_html: :alt Profile picture of Ross A. Baker
[[file:../hugo/static/img/profile.jpg]]
#+end_aside

[[*About][Ross A. Baker]] fell in love with the open web in the 1990s, before
siloed apps, follower counts, reaction emoji, and gamification.  This
project is his attempt to rekindle that initial wonder.

Enclosed is a sprawling experiment in [[*Configurations][literate configuration]], plus
archives of Ross' [[*Talks][talks]], [[*Projects][projects]], [[*Podcasts][podcasts]], and [[*Publications][publications]].  A blog
is planned.

Shared interests may be revealed via [[/categories][categories]] (coarse) or [[/tags][tags]]
(fine).  Enjoy.
...
#+begin_src html :tangle ../../.hugo-out/layouts/_default/_markup/render-heading.html
...
Align the symbol as a superscript:
...
:EXPORT_HUGO_LASTMOD: <2022-09-04 Sun 22:11>
:END:
...
:EXPORT_FILE_NAME: _index
:END:
** TODO Running up the score in Scrabble           :@personal:grandma:eulogy:
SCHEDULED: [2022-09-10 Sat 10:30]
:PROPERTIES:
:EXPORT_FILE_NAME: running-up-the-score-in-scrabble
:END:

Grandma and I had a tradition of playing Scrabble.  Her tradition
predated mine.  The box still held score pads with relatives I never
met.  That set was unfathomably old to my teenaged self, but at least
it was the Modern English Alphabet Edition.  True to Grandma's
stewardship, it still had all its pieces.

She won the first several matches.  One time, after sealing another
victory, she remained hunched over the rack, running up the score on
her own grandson.  "Really, Grandma?"  She explained that it's not
worth doing if it's not worth your best.  She also pointed out I lost
by hanging a vowel right next to the triple word score.

Her blood runs through my veins, which is to say that I am also
stubborn.  I read a strategy guide.  When we met again, no more long
...
"She's been playing that one for years," my aunt sighed.

We didn't have the official Scrabble Dictionary, but still bitter, I
checked [[https://scrabble.hasbro.com/en-us/tools#dictionary][hasbro.com's dictionary]] this week.  Grandma was right, you
know.
...
Another time she asked about a poor grade.  "Well, to whom much is
given, much is expected."  I didn't recognize the scriptural reference[fn:1]
at the time, but that one hit me like a truck.  It wasn't my best.  My
effort had disappointed Grandma.

She gave me more tips than I ever got from that Scrabble book.
Eventually I did win.  I never got the consistent upper hand in
Scrabble, but she made me better, in so many ways.  Her gifts were
teaching and inspiration, so she was expected to bring out the best in
each of us.
...
told St. Peter.  "I want to look at the rules!"  But there's nothing
to be worried about.  Grandma, you always did your best.
...
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: publications
:END:
** Publications
:PROPERTIES:
:EXPORT_FILE_NAME: _index
