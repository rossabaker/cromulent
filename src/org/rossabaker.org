...
:EXPORT_HUGO_LASTMOD: <2022-11-02 Wed 16:26>
:END:
...
#+begin_src sh :results verbatim :exports none
  gpg --homedir "$TMPDIR" --show-keys ../keys/0x975BE5BC29D92CA5.pub.gpg
#+end_src
...
:EXPORT_HUGO_LASTMOD: <2022-11-02 Wed 20:54>
:END:
...
** DONE Web Key Directory                            :pgp:gnupg:wkd:indieweb:
...
#+begin_src emacs-lisp :exports none
  (mkdir "../../tmp/hugo/content/.well-known/openpgpkey/" t)
  (write-region "" nil "../../tmp/hugo/content/.well-known/openpgpkey/policy")
#+end_src
...
#+begin_src sh :noweb yes
  gpg --export ross@rossabaker.com > <<calculate-wkd-hash()>>
#+end_src

# This actually does it for
#+name: export-gpg-key
#+begin_src emacs-lisp :exports none :noweb yes
  (mkdir "../../tmp/hugo/content/.well-known/openpgpkey/hu" t)
  (copy-file "../keys/0x975BE5BC29D92CA5.pub.gpg"
             "../../tmp/hugo/content/.well-known/openpgpkey/hu/<<calculate-wkd-hash()>>"
             t)
#+end_src
