...
[[file:~/src/cromulent/src/hugo/static/img/profile.jpg]]
#+end_aside
...
gamification that pervades today's content.  This project is his
attempt to rekindle the original joy of networking.
...
configuration]].  A blog is planned.

Common interests may be discovered in the coarse [[/categories][categories]] or finer
[[/tags][tags]].
