...
:EXPORT_HUGO_LASTMOD: <2022-08-28 Sun 17:24>
...
#+begin_src css :tangle ../../.hugo-out/assets/css/cromulent.css
  ...
  ul.pages article header h1 {
      font-size: 1.25em;
      margin-bottom: 0.25em;
  }

  ul.pages article main {
      margin: 1em 0;
  }

  ul.pages article header ul, ul.pages article footer ul {
      font-size: 0.8em;
  }
  ...
  ul.pages article header li, ul.pages article footer li {
      display: inline;
      margin-right: 0.5ch;
  }

  ul.pages li.category::before {
      content: "📁 ";
  }

  ul.pages li.tag::before {
      content: "🏷️ ";
  }

  ul.pages li.publish-date::before {
      content: "📅";
  }

  ul.pages li.last-modified-date::before {
      content: "🔄";
  }
#+end_src
