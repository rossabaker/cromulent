...
hosts an experiment in [[*Configurations][literate configuration]] and an [[*Articles][inchoate blog]].
Archives of my [[*Talks][talks]], [[*Projects][projects]], [[*Podcasts][podcasts]], and [[*Publications][publications]] are under
...
:EXPORT_HUGO_LASTMOD: <2022-09-10 Sat 10:51>
:END:
...
:EXPORT_FILE_NAME: _index
:END:
** DONE The AOL of the 2020s :@tech:community:gitter:discord:slack:open_web:aol:
CLOSED: <2022-09-10 Sat 01:29>
:PROPERTIES:
...
- My current role involves a lot of teaching.  We use Slack,
  ...
  what I can on this [[*Articles][nascent blog]].
...
- I challenge you to contribute back to the open web.  [[*Website index][My setup]] is
