...
:EXPORT_HUGO_LASTMOD: <2022-11-02 Wed 13:23>
:END:

** PGP

#+begin_src sh :results verbatim :exports none
  mkdir -p ../../tmp/hugo/content/keys/
  gpg --enarmor <../hugo/static/.well-known/openpgpkey/hu/eimhw3om3jynrs7fo7r7rrssmt1o4yxp >../../tmp/hugo/content/keys/0x975BE5BC29D92CA5.pub.asc
#+end_src

#+RESULTS:

My public key is published to this domain via [[https://wiki.gnupg.org/WKD][WKD]], and can also be
downloaded in [[/.well-known/openpgpkey/hu/eimhw3om3jynrs7fo7r7rrssmt1o4yxp][binary]] and [[/keys/0x975BE5BC29D92CA5.pub.asc][ASCII armored]] formats.  Its fingerprint is:
