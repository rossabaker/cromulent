...
:EXPORT_HUGO_LASTMOD: <2022-10-28 Fri 11:38>
:END:
...
:EXPORT_HUGO_LASTMOD: <2022-10-17 Mon 14:58>
:END:
...
Neat.  This draws candy stripes next to the headers.  The negative
margin and corresponding padding hang the stripes off to the left.
...
look back on our digital lives.  I reflected on perfectionism and
proprietorship.  I've made mistakes with each, and I hope the Indieweb
is the solution.
...
hyperlinked football schedules before ESPN had them.  Navigation was a
Java applet, with the crude animations that JavaScript could not yet
render.  There was a boast about my girlfriend[fn:4].  Ugh, the
justified margins!
...
any remains of Teenage Ross at all.

*** A gap in the fossil record

As the 21st Century dawned, the Web and I each got more serious.  It
was time to put the applets away and drop the handle "Spanky"[fn:6].
I had swirling thoughts about:
...
Personal Brand™.  So I didn't develop a brand at all.  Vicenarian Ross
...
I've been in fiddling with the typography and navigation for weeks
before announcing a grand opening, but that's a stall tactic: there is
no perfect.  Platforms like Medium and Substack remove the
distractions, but preserve nothing.
...
I cringed while revisiting my old self, but then I appreciated all the
