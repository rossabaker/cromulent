...
#+attr_html: :class perfectly-cromulent-developer
#+begin_aside
#+attr_html: :alt Mrs. Hoover and Mrs. Krabappel from the Simpsons smoking.  Mrs. Hoover says, &quot;He's a perfectly cromulent developer.&quot;
[[file:../hugo/static/img/perfectly-cromulent-developer.gif]]
#+end_aside

[[*About][Ross A. Baker]] fell in love with the open web in the 1990s, but became
disillusioned by walled gardens, follower counts, reaction emoji, and
gamification that followed.  This project is his attempt to rekindle
the joy of networking.

# These shouldn't have needed to be absolute links...

Enclosed you will find archives of Ross' [[/talks][talks]], [[/projects][projects]], [[/podcasts][podcasts]],
and [[/publications][publications]], plus a sprawling experiment in [[*Configurations][literate
configuration]].  A blog is planned.  Find common interests in coarse
[[/categories][categories]] or finer [[/tags][tags]].

As in real life, he fills awkward gaps with Simpsons references.
...
Scale ~<aside>~ elements reasonably.
