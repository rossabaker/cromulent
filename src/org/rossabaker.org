...
:EXPORT_HUGO_LASTMOD: <2022-10-29 Sat 00:44>
:END:
...
#+begin_text
I had a late twentieth-century personal web site, replete with
[[https://docs.oracle.com/javase/tutorial/deployment/applet/index.html][Java applets]], pet pictures, [[https://datatracker.ietf.org/doc/html/rfc3875][CGI scripts]], and other assorted juvenilia.
I gave it up, and I don't know why.  It was a /perfectly cromulent/
website.

This is my Indieweb reboot.
#+end_text
#+end_intro
...
#+begin_src conf-toml :tangle ../../tmp/hugo/config.toml
  ...
  [[Params.contacts]]
  network = 'Mastodon'
  handle = '@rossabaker@mastodon.social'
