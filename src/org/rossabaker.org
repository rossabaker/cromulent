...
:EXPORT_HUGO_LASTMOD: <2022-11-02 Wed 13:01>
:END:

** PGP

#+begin_src sh :results verbatim :exports none
  mkdir -p ../../tmp/hugo/static/keys/
  gpg --enarmor <../hugo/static/.well-known/openpgpkey/hu/eimhw3om3jynrs7fo7r7rrssmt1o4yxp >../../tmp/hugo/static/keys/0x975BE5BC29D92CA5.pub.asc
#+end_src

#+RESULTS:

My public key is published to this domain via [[https://wiki.gnupg.org/WKD][WKD]], and can also be
downloaded in [[/.well-known/openpgpkey/hu/eimhw3om3jynrs7fo7r7rrssmt1o4yxp][binary]] and [[file:../../tmp/hugo/static/keys/0x975BE5BC29D92CA5.pub.asc][ASCII armored]] formats.  Its fingerprint is:

#+name: pgp-fingerprint
#+begin_src sh :results verbatim :exports none
  gpg --show-keys <../hugo/static/.well-known/openpgpkey/hu/eimhw3om3jynrs7fo7r7rrssmt1o4yxp
#+end_src
...
We also generate some "static" resources that should maybe be assets?
