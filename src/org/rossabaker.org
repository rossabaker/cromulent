...
last child of the last child is sloppy, but I haven't figured out
another way to hug it.
...
#+begin_src css :tangle ../../.hugo-out/assets/css/cromulent.css
  ...
  body > header > *:last-child > *:last-child::after {
      content: "))";
  }
#+end_src
...
[[*Contact][contact page]].  They share a common definition.
#+hugo:more
***** Site parameters
