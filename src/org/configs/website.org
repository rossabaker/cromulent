...
#+LAST_MODIFIED: <2023-06-10 Sat 23:41 EDT>

This defines the custom [[https://orgmode.org/worg/dev/org-export-reference.html#back-end][Org Export backend]] and derivation that drives
rossabaker.com.
