...
:EXPORT_HUGO_LASTMOD: [2023-11-27 Mon 19:55 EST]
:header-args+: :code-license MIT
:EXPORT_OPTIONS: h:6
:END:
...
:EXPORT_HUGO_LASTMOD: [2023-11-22 Wed 20:09 CST]
:CUSTOM_ID: abe
:END:
...
#+begin_src nix :tangle ../../gen/flake/nixos/abe/configuration.nix
  { config, pkgs, ... }:
...
#+begin_src nix :tangle ../../gen/flake/nixos/abe/hardware-configuration.nix
...
#+begin_src nix :tangle ../../gen/flake/nixos/abe/users.nix
  { ... }:
...
#+begin_src nix :tangle ../../gen/flake/nixos/abe/borgbackup.nix
  { config, ... }:
...
#+begin_src nix :tangle ../../gen/flake/nixos/abe/mastodon.nix
  { config, lib, ... }:
...
#+begin_src nix :tangle ../../gen/flake/nixos/abe/synapse.nix
  { pkgs, ... }:
...
#+begin_src nix :tangle ../../gen/flake/nixos/abe/forgejo.nix
  let
...
#+begin_src nix :tangle ../../gen/flake/nixos/abe/netdata.nix
    { lib, pkgs, ... }:
