...
:EXPORT_HUGO_LASTMOD: [2023-10-08 Sun 23:25 EDT]
:header-args+: :code-license CC0-1.0
:END:
...
- [[https://getbootstrap.com/docs/5.3/content/reboot/][~bootstrap-reboot.css~]] :: a trite CSS reset, licensed [[https://raw.githubusercontent.com/twbs/bootstrap/v5.3.2/LICENSE][MIT]].  I am not
  a frontend engineer.
- [[#css-baseline][~cromulent.css~]] :: our own CSS baseline
- ~chroma.css~ :: [[*Syntax highlighting][generated below]].

#+begin_src conf-toml :tangle ../../tmp/hugo/config.toml
  [Params]
    css = [ 'bootstrap-reboot.css', 'cromulent.css', 'chroma.css' ]
    js = [ 'copy-button.js' ]
...
:EXPORT_HUGO_LASTMOD: [2023-10-09 Mon 21:05 EDT]
:END:
...
:EXPORT_HUGO_LASTMOD: [2023-10-13 Fri 23:49 EDT]
...
This is slimmed down considerably after the adoption of [[https://getbootstrap.com/docs/5.3/content/reboot/][Bootstrap
Reboot]].
...
My beloved Indiana Hoosiers wear [[https://www.thedailyhoosier.com/did-you-know-indianas-iconic-candy-stripes-didnt-originate-in-the-basketball-program/][candy-striped pants]].  So shall my website.

#+begin_src css :tangle ../../tmp/hugo/assets/css/cromulent.css
  :root {
      --cromulent-crimson: #9d2235;
      --cromulent-cream: #fff;
  }
#+end_src
...
#+begin_src css :tangle ../../tmp/hugo/assets/css/cromulent.css
  :root {
      --bs-heading-color: var(--cromulent-crimson);
      --bs-body-bg: var(--cromulent-cream);
...
This draws candy stripes beneath the main ~h1~.
  ...
  main h1::after {
      ...
      background-image:
          linear-gradient(to right,
                          var(--cromulent-cream) 50%,
                          var(--cromulent-crimson) 0%);
...
:PROPERTIES:
:EXPORT_FILE_NAME: _index
:EXPORT_HUGO_LASTMOD: [2023-09-24 Sun 20:51 EDT]
