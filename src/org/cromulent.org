...
:EXPORT_HUGO_LASTMOD: [2023-11-28 Tue 23:01 EST]
:CUSTOM_ID: abe
:END:
...
#+begin_src nix :tangle ../../gen/flake/hosts/abe/synapse.nix
  { pkgs, ... }:
...
#+begin_src nix :tangle ../../gen/flake/hosts/abe/forgejo.nix
  let
...
>>>>>>> 1c47690c8 (Extract netdata module)
...
:EXPORT_HUGO_LASTMOD: [2023-11-27 Mon 20:02 EST]
:header-args+: :code-license CC0-1.0
:header-args:nix+: :code-license MIT
:END:
