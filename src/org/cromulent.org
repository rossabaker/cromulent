...
All content on ~rossabaker.com~, unless otherwise specified, is shared
under a [[https://creativecommons.org/licenses/by/4.0/][Creative Commons Attribution-ShareAlike 4.0 International]]
(~CC-BY-SA-4.0~) license.  Attributions and exceptions are provided
...
on this site are tagged with a [[https://spdx.org/licenses/][SPDX identifier]] of an alternate license
that may be applied to the code.  For example, the following snippet
is tagged ~CC0-1.0~ and thus is available under the [[https://spdx.org/licenses/CC0-1.0.html][Creative Commons
