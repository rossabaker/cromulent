...
:EXPORT_HUGO_LASTMOD: [2023-09-17 Sun 20:05 EDT]
:header-args+: :code-license MIT
:EXPORT_OPTIONS: h:6
:END:
...
#+begin_src nix :tangle ../../gen/flake/default.nix
  inputs:
...
:EXPORT_FILE_NAME: _index
:EXPORT_HUGO_LASTMOD: [2023-09-16 Sat 22:52 EDT]
:END:
...
:header-args:nix+: :code-license MIT
:EXPORT_HUGO_LASTMOD: [2023-09-17 Sun 21:10 EDT]
:CUSTOM_ID: hyperlink
:END:
...
#+begin_info
This package has been a [[https://github.com/NixOS/nixpkgs/pull/255416][merged to nixpkgs]].  This derivation will be
removed once it propagates to ~nixos-unstable~.
#+end_info
