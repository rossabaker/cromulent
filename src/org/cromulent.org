...
:EXPORT_HUGO_LASTMOD: [2023-10-20 Fri 22:42 EDT]
...
[[https://www.w3.org/TR/WCAG22/#text-spacing][{{acronym("WCAG", "Web Content Accessibility Guidelines")}}]] requires
support for line spacing up to 1.5 times the font size and paragraph
spacing two times the font size.  Looks nice!
...
They fade out and in with gradients inspired by [[https://css-tricks.com/easing-linear-gradients/][Easing Linear Gradients]].
