...
Ideally, it would be provisioned by [[https://opentofu.org/][OpenTofu]], but Hetzner Robot
instances aren't as ephemeral as Hetzner Cloud.  NixOS was installed
from the rescue image with a [[https://github.com/nix-community/nixos-install-scripts/blob/5dc786009cf8595090bfa8e337df2ff1693e825a/hosters/hetzner-dedicated/hetzner-dedicated-wipe-and-install-nixos.sh][Nix community script]].
...
:EXPORT_HUGO_LASTMOD: [2023-12-03 Sun 00:27 EST]
:END:
