...
:EXPORT_HUGO_LASTMOD: [2023-10-08 Sun 00:15 EDT]
:END:
...
That's the only use of WebFinger on ~rossabaker.com~ at this time.
The only supported resource today is ~acct:ross@rossabaker.com~, so
that's fine here.
...
:EXPORT_HUGO_LASTMOD: [2023-10-08 Sun 00:35 EDT]
