...
:EXPORT_HUGO_LASTMOD: [2023-10-08 Sun 23:22 EDT]
...
#+begin_src css :tangle ../../tmp/hugo/assets/css/cromulent.css
  :root {
      --bs-heading-color: #9d2235;
      --bs-body-bg: #ffffff;
      --bs-link-color: #146357;
      --bs-link-color-rgb: 20, 99, 87;
  }
#+end_src
...
#+begin_src css :tangle ../../tmp/hugo/assets/css/cromulent.css
  main h1::after {
      content: "";
      background-image: linear-gradient(to right, var(--bs-body-bg) 50%, var(--bs-heading-color) 0%);
...
:EXPORT_FILE_NAME: _index
:EXPORT_HUGO_LASTMOD: [2023-10-02 Mon 23:14 EDT]
:END:
