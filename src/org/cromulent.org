...
:EXPORT_HUGO_LASTMOD: [2023-12-09 Sat 21:54 EST]
:CUSTOM_ID: abe
...
This server hosts [[#libravatar][Libravatar]].  It needs to be configured for Nix:
...
Also for Terraform.  An ~avatars.rossabaker.com~ alias is created for
~abe~.
