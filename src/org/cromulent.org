...
:PROPERTIES:
:EXPORT_FILE_NAME: _index
:EXPORT_HUGO_LASTMOD: [2023-09-10 Sun 01:14 EDT]
...
This part is grody.  Ideally, we'd define a [[https://orgmode.org/worg/dev/org-export-reference.html][derived backend]], but
...
We have to mutate the global settings for Ox-Hugo.  This is
fine as long as we don't have Ox-Hugo sites incompatible with this
extension.  We do the mutation via a minor mode:
