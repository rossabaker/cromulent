...
:EXPORT_HUGO_LASTMOD: [2023-10-21 Sat 00:37 EDT]
...
#+begin_src css
  h1, h2, h3, h4, h5, h6, p {
      margin-block: calc(var(--cromulent-step-4) * 1rem);
  }
#+end_src
...
:PROPERTIES:
:EXPORT_FILE_NAME: _index
:EXPORT_HUGO_LASTMOD: [2023-10-25 Wed 21:54]
...
[[https://github.com/ag91/scala-cli-repl][scala-cli-repl]] lets us run Scala in Org mode.
