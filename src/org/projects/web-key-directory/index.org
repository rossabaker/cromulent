...
#+date: <2022-11-02 Wed 23:39>
#+lastmod: <2022-11-15 Tue 16:22>
#+description: Walks through publishing a public key with the Web Key Directory (WKD) protocol.
#+filetags: PGP WKD Indieweb
#+redirect_from: /configs/web-key-directory
...
#+begin_src emacs-lisp :results silent :exports none
  (setq-local ross-www/public-html-directory (expand-file-name "../../../../tmp/public_html/"))
#+end_src
...
#+begin_src sh :var PUBLIC_HTML=(identity ross-www/public-html-directory) :session wkd
  cd $PUBLIC_HTML
#+end_src
