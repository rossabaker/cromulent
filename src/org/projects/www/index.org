...
The main branch publishes to my personal Cachix and GitHub pages.

#+begin_src yaml :tangle ../../../../.github/workflows/publish.yml :eval no
name: publish
on:
